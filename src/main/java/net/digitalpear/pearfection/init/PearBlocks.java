...
public class PearBlocks {
    ...
    public static final Block LAMPEAR = createLampear("lampear", LampearBlock::new, AbstractBlock.Settings.create()
    ...
    public static final Block COPPER_LAMPEAR = createLampear("copper_lampear", LampearBlock::new, AbstractBlock.Settings.create()
            .luminance((state) -> 14).nonOpaque().strength(0.7f, 0.3f).mapColor(Blocks.COPPER_BLOCK.getDefaultMapColor())
            .sounds(PearSoundEvents.BLOCK_SOUND_PEAR), PearFoodComponents.COPPER_LAMPEAR, PearConsumableComponents.COPPER_LAMPEAR, Rarity.RARE);


    public static final Block LAMPEAR_BLOCK = createBlockWithItem("lampear_block", MushroomBlock::new, AbstractBlock.Settings.create()
