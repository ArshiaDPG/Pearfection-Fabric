...
public class PearConfiguredFeatures {
    ...
    public static HugeLampearFeatureConfig createDefaultConfig(IntProvider heightProvider){
        ...
        DataPool.Builder<BlockState> LEAVES = new DataPool.Builder<BlockState>()
                .add(PearBlocks.CALLERY_LEAVES.getDefaultState(), 2)
                .add(PearBlocks.FLOWERING_CALLERY_LEAVES.getDefaultState(), 1);
        DataPool.Builder<BlockState> FRUITS = new DataPool.Builder<BlockState>()
