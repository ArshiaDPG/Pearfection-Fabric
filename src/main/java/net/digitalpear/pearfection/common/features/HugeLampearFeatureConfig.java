...
public class HugeLampearFeatureConfig implements FeatureConfig {
    ...
    public static final Codec<HugeLampearFeatureConfig> CODEC = RecordCodecBuilder.create((instance) ->
            instance.group(
                            ...
                            FloatProvider.VALUE_CODEC.fieldOf("max_grow_through_hardness").orElse(ConstantFloatProvider.create(1.4f)).forGetter(config -> config.maxGrowThroughHardness),
                            FloatProvider.createValidatedCodec(0f, 1.0f).fieldOf("fruit_spawn_chance").orElse(ConstantFloatProvider.create(0.2f)).forGetter(config -> config.fruitSpawnChance))
    ...
    public final FloatProvider maxGrowThroughHardness;
    public final FloatProvider fruitSpawnChance;
    public final IntProvider height;
    public HugeLampearFeatureConfig(BlockStateProvider trunkProviders, BlockStateProvider foliageProviders, BlockStateProvider baseBlockProviders, BlockStateProvider fruitProviders, IntProvider height, FloatProvider maxGrowThroughHardness, FloatProvider fruitSpawnChance) {
