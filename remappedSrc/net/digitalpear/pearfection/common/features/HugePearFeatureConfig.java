...
public class HugePearFeatureConfig implements FeatureConfig {
    ...
    protected HugePearFeatureConfig(BlockStateProvider stemProvider, BlockStateProvider foliageProvider, BlockStateProvider baseBlockProvider, BlockStateProvider fruitProvider) {
