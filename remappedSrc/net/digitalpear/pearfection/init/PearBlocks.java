...
public class PearBlocks {
    ...
    public static final Block LAMPEAR_BLOCK = createBlockWithItem("lampear_block", new MushroomBlock(AbstractBlock.Settings.of(Material.MOSS_BLOCK, state -> state.get(MushroomBlock.UP) ? calleryColor : MapColor.LICHEN_GREEN).sounds(PearSoundEvents.BLOCK_SOUND_PEAR)
